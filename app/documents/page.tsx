        ...
        docs: [
            {
                ...
                description:
                    "My professional CV with experience, education, and skills.",
            },
        ],
    },
    {
        ...
        docs: [
            {
                name: "KNW106.pdf",
                title: "Module 106",
                description: "Project and Portfolio Management certification.",
            },
            {
                name: "KNW187.pdf",
                title: "Module 187",
                description: "Java Enterprise Beans certification.",
            },
            {
                name: "KNW210.pdf",
                title: "Module 210",
                description: "Web Application Development certification.",
            },
            {
                name: "KNW294.pdf",
                title: "Module 294",
                description: "User Interfaces certification.",
            },
            {
                name: "KNW295.pdf",
                title: "Module 295",
            ...
            },
            {
                name: "KNW335.pdf",
                title: "Module 335",
                description: "Business Process Automation certification.",
            },
        ],
    },
    {
        ...
        docs: [
            {
                ...
                description: "Technical certification in financial accounting.",
            },
            {
                name: "abacus-debitorenbuchhaltung.pdf",
                title: "Abacus Accounts Receivable",
                description: "Technical certification in accounts receivable.",
            },
            {
                name: "abacus-kreditorenbuchhaltung.pdf",
                title: "Abacus Accounts Payable",
                description: "Technical certification in accounts payable.",
            },
        ],
    },
];
        ...
        if (token) {
            try {
                const res = await fetch(
                    `${API_BASE_URL}/blobs/secure/${name}`,
                    {
                        headers: {
                        ...
                        <div className="relative flex items-center justify-center w-full">
                            <div className="relative flex flex-col place-items-center text-center before:-z-10 before:absolute before:h-[300px] before:w-full before:-translate-x-1/2 before:rounded-full before:bg-gradient-radial before:blur-2xl before:content-[''] after:absolute after:-z-20 after:h-[180px] after:w-full after:translate-x-1/3 after:bg-gradient-conic after:blur-2xl after:content-[''] before:dark:bg-gradient-to-br before:dark:from-transparent before:dark:to-blue-700 before:dark:opacity-10 after:dark:from-sky-900 after:dark:via-[#0141ff] after:dark:opacity-40 sm:before:w-[480px] sm:after:w-[240px] before:lg:h-[360px]">
                                ...
                                <p className="text-gray-300 text-lg max-w-2xl">
                                    A collection of my certifications, reports,
